...
%     lprob = chis_prb(lratio,neqs*neqs); 
 ...
 if critaic < critaicm
  critaicm=critaic; lagsoptaic=i;
 end
 if critbic < critbicm
  critbicm=critbic; lagsoptbic=i;
 end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
...
if nargout == 2
    for i=1:maxlag
     if xflag == 0
      resid = var_res(y,i); initres(i,:)=resid(1,:);
     else
      resid = varx_res(y,i,x); initres(i,:)=resid(1,:);
     end
    end
end
